...
$no=1;
$sql = "SELECT * FROM tbl_pengelola WHERE id_pengelola='$id' "; 
...
<div id="main">
	<div class="content">
		<h3>Entry Pengelola</h3>
		<form action="updatepengelola.php" method="POST" enctype="multipart/form-data">
			<div class="input-group">
				<input type="text"  value="<?php echo $tampil['id_pengelola']; ?>" name="id_pengelola">
			</div>
			<div class="input-group">
				<input type="text"  name="nama_pengelola" value="<?php echo $tampil['nama_pemgelola']; ?>">
			</div>
			<div class="input-group">
				<input type="text" style="width: 300px;" name="alamat_pengelola" value="<?php echo $tampil['alamat_pengelola']; ?>">
			</div>
			<div class="input-group">
