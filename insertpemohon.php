...
$query	= "INSERT INTO tbl_pemohon values('$idpnp','$nmpnp','$alamat','$nohp','$umurpnp','$jekelamin','$tlahir','$tgllahir','".$_FILES["foto"]["name"]."')";
$result = mysqli_query($conn,$query)or die(mysqli_error());
if($result){
	echo "<script type='text/javascript'>
	alert('Data Berhasil Disimpan..!');
</script>";
echo "<meta http-equiv='refresh' content='0; url=entry_pemohon.php'>";
}else{
	echo "<script type='text/javascript'>
	onload =function(){
...
echo "<meta http-equiv=refresh content=3;url=entry_pemohon.php>";
}
?>
