...
$no = 1;
$sql = "SELECT * FROM tbl_pengelola ORDER BY id_pengelola DESC limit 1"; 
...
<div id="main">
	<div class="content">
		<h3>Entry Pegelola</h3>
		<form action="insertpengelola.php" method="POST" enctype="multipart/form-data">
			<div class="input-group">
				<input type="text" placeholder="Nomor Indentitas Pengelola" value="<?php while($rows=mysqli_fetch_array($hasil)){ $num = $rows['id_pengelola']+$no; echo $num; }?>" name="id_pengelola">
			</div>
			<div class="input-group">
				<input type="text" placeholder="Nama Pengelola" name="nama_pengelola">
			</div>
			<div class="input-group">
				<input type="text" placeholder="Alamat Pengelola" style="width: 300px;" name="alamat_pengelola">
			</div>
			<div class="input-group">
			...
			<div class="input-group">
				...
				<div class="input-group">
					<label for="">Foto Pengelola</label>
			...
			<?php include('data/data_pengelola.php'); ?>
		</div>
	</div>
